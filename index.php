...
?>
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('assets/img/1920x1080/02.jpg');">
                ...
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('assets/img/1920x1080/01.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <div class="g-margin-b-30--xs">
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-text-center--xs g-margin-b-100--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Welcome to my blog</p>
        ...
        <div class="g-promo-section">
                ...
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        ...
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Muneeb Ahmad Faruqi</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-md-offset-1">
                        <p class="g-font-size-18--xs">Muneeb Ahmad Faruqi is a PHP developer and technical support person at XYZ company, He is motivated, task oriented and team player. He can develop websites like CRMs, single page sites, multipage sites.</p>
            ...
            <div class="col-sm-3 g-promo-section__img-right--lg g-bg-position--center g-height-100-percent--md js__fullwidth-img">
                <img class="img-responsive" src="assets/img/pic.jpg" alt="Image">
            </div>
        </div>
        <!-- End Culture -->

        <!-- Subscribe -->
        <div class="js__parallax-window" style="background: url(assets/img/1920x1080/07.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                       ...
                       <a class="s-btn s-btn-icon--md  s-btn--white-brd" href="signup.php">Signup</a>
        ...
        <?php
            ...
            $qry_get_post= "SELECT * from tbl_posts";
            $result_qry_get_post= mysqli_query($link,$qry_get_post);
            if(mysqli_num_rows($result_qry_get_post)>0){
                ?>
                <div class="row">
                <?php
                while ($row= mysqli_fetch_assoc($result_qry_get_post)) {
                    
                    $img_source= $row['post_pic'];
                    $post_id= $row['post_id'];
                ?>
                ...
                <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                    ...
                    <article>
                        ...
                        <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2" style="display: none;">News</p>
                            <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href='view_post.php?post=<?php echo $post_id; ?>'><?php echo $row['post_title']; ?></a></h3>
                    ...
                    <div class="row g-margin-b-40--xs">
                        <div class="col-sm-6 g-margin-b-20--xs g-margin-b-0--md">
                            <div class="g-margin-b-20--xs">
                                <input type="text" class="form-control s-form-v2__input " placeholder="* Name">
                            </div>
                            <div class="g-margin-b-20--xs">
                                <input type="email" class="form-control s-form-v2__input " placeholder="* Email">
                            </div>
                            <input type="text" class="form-control s-form-v2__input " placeholder="* Phone">
                        </div>
                        <div class="col-sm-6">
                            <textarea class="form-control s-form-v2__input  g-padding-y-20--xs" rows="8" placeholder="* Your message"></textarea>
                        </div>
                    </div>
                    <div class="g-text-center--xs">
                        <button type="submit" class="text-uppercase s-btn s-btn--md s-btn--primary-bg  g-padding-x-80--xs">Submit</button>
                    </div>
                </form>
            </div>
        </div>
